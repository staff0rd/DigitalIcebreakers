...
function readAliasFromTsConfig(): { [find: string]: string } {
  ...
  return aliases.reduce((aliases, alias) => {
    aliases[alias.find as string] = alias.replacement;
    return aliases;
  }, {} as { [find: string]: string });
}
