...
export class Slides extends Component<SlidesProps, SlidesState> {
  ...
  ifPresenter(content: any) {
    if (this.props.isPresenter) return content;
    else
      return (
  ...
  diagram(image: string) {
    ...
    return (
      <section
        style={params.style}
        data-background-image={params.path}
      ...
      <div className="slides" ref={this.theElement}>
        ...
        <section
          ...
          data-background-image={
            this.getClientOrPresenterImageParameters("flower-bidding.jpg").path
          }
          data-background-opacity=".5"
        >
          <h1 className="flower" style={{ color: "white" }}>
            Bidding Flower Bouquet
          </h1>
        </section>
        ...
        <section data-background-color="#ffffff">
          <h1>
            Manages transport <br /> method is the key benefit
          </h1>
        </section>
        <section data-background-color="#ffffff">
        ...
        <section data-background-color="#ffffff">
          <h2>
            {" "}
            Originated in 2011 <br /> David Fowler, Damian Edwards
          </h2>
        </section>
        <section data-background-color="#ffffff">
        ...
        <section data-background-color="#ffffff">
          <h1>
            {" "}
            ASP.NET Core SignalR <br /> is a rewrite!
          </h1>
        </section>
        ...
        >
          ...
          <h3 className="flower" style={{ color: "white" }}>
        ...
        <section>
          <pre>
            <code data-line-numbers="3" data-noescape data-trim>{`
        ...
        <section>
          <h2>npm install @microsoft/signalr</h2>
        </section>
        <section>
          <pre>
            <code className="javascript" data-line-numbers="2-4" data-trim>{`
						constructor() {    
        ...
        <section>
          <pre>
            <code className="javascript" data-line-numbers="7-9" data-trim>{`
						constructor() {    
						  this.hubConnection = new signalR.HubConnectionBuilder()
						    .withUrl("https://serverbidding.azurewebsites.net/bid")
						    .build();
        ...
        <section>
          <pre>
            <code className="javascript" data-line-numbers="2-3" data-trim>{`
						constructor() {
        ...
        <section>
          <pre>
            <code className="javascript" data-line-numbers="6-8" data-trim>{`
						constructor() {
						  this.hubConnection.on("BroadCastClient",
						    this.broadcastCallBack);
						}   
        ...
        <section data-background-color="#ffffff">
          <blockquote className="quote-signalr" cite="Nelly & Stafford">
            &ldquo;SignalR can &nbsp; <br /> handle unlimited persistent
            connections!&rdquo;
          </blockquote>
        </section>
        <section data-background-color="#ffffff">
          <blockquote className="quote-signalr" cite="Nelly & Stafford">
            &ldquo;SignalR can &nbsp;{" "}
            <span style={{ color: "red", position: "absolute" }}> not</span>{" "}
            <br /> handle unlimited persistent connections!&rdquo;
          </blockquote>
        </section>
        <section data-background-color="#ffffff">
        ...
        <section data-background-color="#ffffff">
          <h1>
            Persistent connections <br /> consume resources <br />{" "}
            significantly!
          </h1>
        </section>
