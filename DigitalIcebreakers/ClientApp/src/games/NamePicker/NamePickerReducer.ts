...
import { createGameAction, createReceiveGameMessageReducer } from '../../store/actionHelpers';
...
export const namePickerReducer = createReceiveGameMessageReducer<string, NamePickerState>(
    Name,
    { shouldPick: false }, 
    state => state,
    "presenter",
